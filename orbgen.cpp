...
EX vector<orbinfo> orbinfos = {
  {orbgenflags::S_NATIVE, laGraveyard, 200, 800,itGreenStone}, // must be first so that it does not reduce 
  {orbgenflags::S_NATIVE, laJungle, 1200, 1900,itOrbLightning},
  {orbgenflags::S_NATIVE, laIce, 2000, 2500,itOrbFlash},
  {orbgenflags::S_NATIVE, laCaves, 400, 800,itOrbLife},
  {orbgenflags::S_NATIVE, laAlchemist, 200, 400,itOrbSpeed},
  {orbgenflags::S_NATIVE, laDesert, 500, 750,itOrbShield},
  {orbgenflags::S_YENDOR, laHell, 2000, 1000,itOrbYendor},
  {orbgenflags::S_NATIVE, laRlyeh, 300, 700,itOrbTeleport},
  {orbgenflags::S_NA_O25, laMotion, 1800, 2700, itOrbSafety},    
  ...
  {orbgenflags::S_NAT_NT, laDeadCaves, 800, 1000, itOrbDigging},
  {orbgenflags::S_NATIVE, laEmerald, 1500, 2500, itOrbPsi},
  {orbgenflags::S_NATIVE, laWineyard, 300, 700, itOrbAether},
  {orbgenflags::S_NATIVE, laHive, 800, 1200, itOrbInvis},
  {orbgenflags::S_NATIVE, laPower, 0, 2000, itOrbFire},
  {orbgenflags::S_NATIVE, laMinefield, 0, 400, itOrbFriend},
  {orbgenflags::S_NATIVE, laTemple, 0, 2000, itOrbDragon},
  {orbgenflags::S_NATIVE, laCaribbean, 0, 1500, itOrbTime},
  {orbgenflags::S_NATIVE, laRedRock, 0, 1500, itOrbSpace},
  {orbgenflags::S_NATIVE, laCamelot, 1000, 1500, itOrbIllusion},
  {orbgenflags::S_NATIVE, laOcean, 0, 300, itOrbEmpathy},
  ...
  {orbgenflags::S_NATIVE, laEclectic, 500, 1000, itOrbChaos},
  ...
  {orbgenflags::S_NATIVE, laCursed, 200, 1500, itOrbPurity},
